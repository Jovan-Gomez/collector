...
class Check extends TimerTask{
    ...
    public void run() {
        ...
        // String time1Str = "2021-04-21 17:20:00";
        // String time2Str = "2021-04-21 17:30:00";
            ...
            if (Boolean.FALSE.equals(rs.next())) {
              ...
              if(!myJsonObject.getString("FormGUID").equals("")){
                ...
                break;
                  ...
                  case "16382B37-81E7-4DE9-898C-FE301CF367AA": //LEVANTAMIENTO Y REQUISICION-ISSEMYM-CONTRATO 59
