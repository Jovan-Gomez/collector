...
class Check extends TimerTask {
  ...
  String url1 = "https://api.visitrack.com/api/Surveys/Activities"; // All activities in general (can be filtered
  ...
  @Override
    public void run() {
        ...
        try {
            ...
            c.setTime(date);
            c.add(Calendar.MINUTE, -10);  // number of minutes to addd
            date = c.getTime();
            time = date.getTime();
        ...
        String time1Str = "2021-04-28 11:20:00";
        String time2Str = "2021-04-28 12:00:00";
            ...
            if (Boolean.FALSE.equals(rs.next())) {
              ...
              if(!myJsonObject.getString("FormGUID").equals("")){
                ...
                switch(myJsonObject.getString("FormGUID")){
                  case "8ECF6D3B-1772-4A54-BAB0-C018EC7488AC": //LEVANTAMIENTO Y REQUISICION-IMDD-CONTRATO 61
                  ...
                  unidadMedica = new JSONObject(response).getJSONArray("Values").getJSONObject(1).getString("Value");
                  ...
                  if (ja_values.getJSONObject(tman).getString("Value").compareTo( "Emergencia" ) == 0) {
                    ...
                    queryString3 = "INSERT INTO docDocumentExt (IDExtra,Emergencia,NoTicket,Prioridad,CC,[Dictamen Tecnico],Unidadmedica)"
                                 + "SELECT "+iddoc+",1,?,?,?,?,?;"
                ...
                break;
                  ...
                  case "0F34638A-74DB-458D-8AA0-658B1F3819C0": //LEVANTAMIENTO Y REQUISICION-ISSEMYM-CONTRATO 47
                    ...
                    if (ja_values.getJSONObject(tman).getString("Value").compareTo( "Emergencia" ) == 0) {
                      ...
                      queryString3 = "INSERT INTO docDocumentExt (IDExtra,Emergencia,NoTicket,Prioridad,CC,[Dictamen Tecnico],Unidamedica)"
                                   + "SELECT "+iddoc+",0,?,?,?,?,?;"
                                   + "INSERT INTO docDocumentCFD (DocumentID,FinancialOperationID,Anexo20Ver)"
                                   + "SELECT "+iddoc+",0,'3.3'";
                    }
                  ...
                  case "BB8B1A3E-C6E1-4A2D-8E46-AF9C0C3660B0": //LEVANTAMIENTO Y REQUISICION-ISSEMYM-CONTRATO 60
